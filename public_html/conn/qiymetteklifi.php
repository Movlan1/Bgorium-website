...
function priceorder($kimden, $kime, $konu, $mesaj, $config) {
...
<?php
    ...
    if(isset($_POST["callSubmit"])) {
        ...
        if($nameAndSurname == "" || $phoneNumber == "" || $email == "" || $message == "") {
            ...
            if(priceorder($config["smtp_user"], $config["smtp_user"], "progress saytından test mesaj", $mesajk, $config)) {
