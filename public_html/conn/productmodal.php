...
function productModal($kimden, $kime, $konu, $mesaj, $config) {
...
<?php
    ...
    if(isset($_POST["sendModal"])) {
        ...
        if($nameAndSurname == "" || $phoneNumber == "" || $email == "" ) {
            ...
            $mesajk .= "<b>Məhsul:</b> $productname <hr />";
            ...
            if(productModal($config["smtp_user"], $config["smtp_user"], "progress saytından test mesaj", $mesajk, $config)) {
        ...
        <form method="post" id="sendmail" name="sendmail" action="">
            ...
            <input type="hidden" name="ipAddress" value="<?php  echo $_SERVER['REMOTE_ADDR'] ;?>" />
             <div class="form-wrapper">
                ...
                <div class="modal-input-wrapper">
                  <input type="text" placeholder="E-mail ünvanınız*" name="email">
                </div>
                <div class="modal-input-wrapper">
