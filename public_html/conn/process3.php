...
if (!$errors) {
	...
	//recipient
	$to = 'Pillekenler.com <eldarehmedzade@mail.ru>';	
	//sender
	$from = $name . ' <' . $email . '>';
	
	//subject and the html message
	$subject = 'Saytdan mesaj: ' . $name;	
	$message = '
	...
	<table style="border: 1px solid #FFC107;">
		...
		<tr><td style="border: 1px solid #FFC107;"><b>Telefonu:</b> </td><td style="border: 1px solid #FFC107;">' . $website . '</td></tr>
		<tr><td style="border: 1px solid #FFC107;"><b>Email:</b> </td><td style="border: 1px solid #FFC107;">' . $email. '</td></tr>
