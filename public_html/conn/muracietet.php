...
function applyFor($kimden, $kime, $konu, $mesaj, $config) {
...
<?php
    ...
    if(isset($_POST["submit"])) {
        ...
        if($nameAndSurname == "" || $phoneNumber == "" || $email == "" || $message == "") {
            ...
            if(applyFor($config["smtp_user"], $config["smtp_user"], "progress saytından test mesaj", $mesajk, $config)) {
        ...
        <form method="post" id="sendmail" name="sendmail" action="">
            ...
            <input type="hidden" name="ipAddress" value="<?php  echo $_SERVER['REMOTE_ADDR'] ;?>" />
                <div class="static_page_form-wrapper">
                    <h5>Müraciət et</h5>
                      <input type="text" placeholder="Ad" id="static_page_form_name" required>
                      <input type="text" placeholder="Soyad" id="static_page_form_surn" required>
                      <input type="tel" placeholder="Telefon" id="static_page_form_tel" required>
                      <input type="email" placeholder="Mail" id="static_page_form_tel" required>
                      <textarea name="" placeholder="Qeydləriniz" id="static_page_form_mes"></textarea>
